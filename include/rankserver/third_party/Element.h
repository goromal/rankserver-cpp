...
public:
    ...
    Element(const char* apName, std::string&& aContent) : mName(apName), mContent(aContent) {}
    Element(const char* apName, const std::string& aContent) : mName(apName), mContent(aContent) {}
...
{
public:
    explicit Input(const char* apType    = nullptr,
                   const char* apName    = nullptr,
                   const char* apValue   = nullptr,
                   const char* apContent = nullptr)
    ...
    { // NOLINT(build/include_what_you_use) false positive
        return addAttribute("max", aMax);
    }
    Input&& max(const unsigned int aMax)
    { // NOLINT(build/include_what_you_use) false positive
        return addAttribute("max", aMax);
    }
...
{
public:
    explicit InputHidden(const char* apName, const char* apValue = nullptr) : Input("hidden", apName, apValue) {}
};
...
{
public:
    explicit InputText(const char* apName, const char* apValue = nullptr) : Input("text", apName, apValue) {}
};
...
{
public:
    explicit InputNumber(const char* apName, const char* apValue = nullptr) : Input("number", apName, apValue) {}
};
...
{
public:
    explicit InputRange(const char* apName, const char* apValue = nullptr) : Input("range", apName, apValue) {}
};
...
{
public:
    explicit InputDate(const char* apName, const char* apValue = nullptr) : Input("date", apName, apValue) {}
};
...
{
public:
    explicit InputTime(const char* apName, const char* apValue = nullptr) : Input("time", apName, apValue) {}
};
...
{
public:
    explicit InputEmail(const char* apName, const char* apValue = nullptr) : Input("email", apName, apValue) {}
};
...
{
public:
    explicit InputUrl(const char* apName, const char* apValue = nullptr) : Input("url", apName, apValue) {}
};
...
{
public:
    explicit InputPassword(const char* apName) : Input("password", apName) {}
};
...
{
public:
    explicit InputSubmit(const char* apValue = nullptr, const char* apName = nullptr) : Input("submit", apName, apValue)
    {
    }
};
...
{
public:
    explicit InputReset(const char* apValue = nullptr) : Input("reset", nullptr, apValue) {}
};
...
{
public:
    Image(const std::string& aSrc,
          const std::string& aAlt,
...
{
public:
    Button(const char* apContent, const char* apType = "button") : Element("button", apContent)
    {
        addAttribute("type", apType);
    }
};
